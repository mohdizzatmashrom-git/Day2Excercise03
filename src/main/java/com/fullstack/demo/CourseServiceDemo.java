...
public class CourseServiceDemo {
    ...
    public static void main(String[] args) {
        ...
        // 1-8: normal flow (create, read, search, filter, assign, search, update, delete)
        try {
        ...
        // 9: Try to find deleted course (should throw CourseNotFoundException)
        ...
        // 10: Invalid duration test (should throw InvalidCourseException)
